...
dataPathProject <- "/n/irizarryfs01_backed_up/shicks/projects/methylCC"
dataPathCarmona <- "/n/irizarryfs01_backed_up/shicks/projects/methylCC/dataFromCarmona-RRBS-450k"
dataPathLiu <- "n/irizarryfs01_backed_up/shicks/projects/methylCC/dataFromLiu2013"
...
# load RRBS data
load(file.path(dataPathCarmona, "bsseqkrawall.RData")) # loads BS object
...
# write.csv(counts.RRBS.Houseman, file = file.path(dataPathCarmona, "cellCountsEsts/rrbs_minfi-projectCellType.csv"),
#           row.names = TRUE)
# counts.RRBS.Houseman <- read.csv(file.path(dataPathCarmona, "cellCountsEsts/rrbs_minfi-projectCellType.csv"), 
#                                  row.names = 1)
...
# write.csv(counts.450k.Hicks, file = file.path(dataPathCarmona, "cellCountsEsts/450k_methylCC-estimateCC.csv"),
#           row.names = TRUE)
# counts.450k.Hicks <- read.csv(file.path(dataPathCarmona, "cellCountsEsts/450k_methylCC-estimateCC.csv"), 
#                        row.names = 1)
...
#           file = file.path(dataPathCarmona, "cellCountsEsts/rrbs_methylCC-estimateCC.csv"),
#           row.names = TRUE)
...
#           file = file.path(dataPathLiu, "cellCountsEsts/450k_minfi-estimateCellCounts.csv"),
#           row.names = TRUE)
...
#           file = file.path(dataPathLiu, "cellCountsEsts/450k_methylCC-estimateCC.csv"),
#           row.names = TRUE)
```
